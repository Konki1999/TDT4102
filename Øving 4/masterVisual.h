...
constexpr int padX = winW / (2*(length+1)+1);      // velg x skalering
constexpr int padY = winH / (2*(maxAttempts+2)+1);      // velg y skalering
constexpr int radCircle = padX / (length*2); // velg sirkel radius
...
void addFeedback(MastermindWindow &win, const int correctPosition, const int correctCharacter,
